...
export type WebCandidate={id:string;title:string;url:string;description:string;sourceName:string;companyName?:string;sourceType?:'web'|'news'|'blog'|'tavily';start?:DatePoint|null;end?:DatePoint|null;dateEvidence?:string;extractedContent?:string};
