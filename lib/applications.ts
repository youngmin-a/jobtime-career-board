...
export const eventLabels={recruitment_start:"모집 시작",recruitment_period:"모집 기간",recruitment_deadline:"모집 마감",exam:"시험",interview:"면접",stage:"전형",result_expected:"결과 예정",result_confirmed:"결과 확인",personal:"개인 일정"} as const;
